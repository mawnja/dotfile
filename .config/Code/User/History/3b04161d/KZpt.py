...
def verify_any_conv2d(
    ...
    check_result([data_np, kernel_np], mod, ref_out_shape, assert_shape=True, targets=targets, disable_targets=disable_targets)
...
def test_TestAnyConv2dNCHWc():
    TestAnyConv2dNCHWc ins
