...
Plug 'maxmx03/solarized.nvim' "theme
Plug 'neoclide/coc.nvim', {'branch': 'release'}
Plug 'nvim-lua/plenary.nvim'
Plug 'nvim-telescope/telescope.nvim', {'tag': '0.1.6'} "quick find
Plug 'nvim-treesitter/nvim-treesitter'
Plug 'windwp/nvim-autopairs'
Plug 'nvim-neo-tree/neo-tree.nvim'  "file explorer
Plug 'nvim-lua/plenary.nvim'
Plug 'nvim-tree/nvim-web-devicons' " not strictly required by neo-tree, but recommended
...
"nnoremap <F3> :Neotree<CR>        "开启/关闭neotree快捷键

nnoremap <leader>n :Neotree toggle current reveal_force_cwd<cr>
nnoremap <leader>f :Neotree reveal<cr>
nnoremap <leader>r :Neotree float reveal_file=<cfile> reveal_force_cwd<cr>
