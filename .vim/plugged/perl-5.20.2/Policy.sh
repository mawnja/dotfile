...
case "$perladmin" in
'') perladmin='wenjian.ma@ops-alienware-17-r4.(none)' ;;
esac
...
case "$siteprefix" in
'') if test "./perl-5.20.2" = "./perl-5.20.2"; then
	siteprefix="$prefix"
    else
	siteprefix='./perl-5.20.2'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "./perl-5.20.2"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
#     ./perl-5.20.2, so it isn't included here either.
#
...
# bin='./perl-5.20.2/bin'
# scriptdir='./perl-5.20.2/bin'
# privlib='./perl-5.20.2/lib/5.20.2'
# archlib='./perl-5.20.2/lib/5.20.2/x86_64-linux-thread-multi'
# man1dir='./perl-5.20.2/man/man1'
# man3dir='./perl-5.20.2/man/man3'
# man1ext='1'
# man3ext='3'
...
html3dir=' '
# sitebin='./perl-5.20.2/bin'
# sitescript='./perl-5.20.2/bin'
# sitelib='./perl-5.20.2/lib/site_perl/5.20.2'
# sitearch='./perl-5.20.2/lib/site_perl/5.20.2/x86_64-linux-thread-multi'
# siteman1dir='./perl-5.20.2/man/man1'
# siteman3dir='./perl-5.20.2/man/man3'
# sitehtml1dir=''
# sitehtml3dir=''
# vendorbin=''
# vendorscript=''
