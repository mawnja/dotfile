...
XS_EUPXS(XS_Devel__PPPort_PL_Sv)
{
    ...
    {
	SV *	RETVAL;
#line 607 "RealPPPort.xs"
                PL_Sv = newSVpv("mhx", 0);
                RETVAL = PL_Sv;
#line 1130 "RealPPPort.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
