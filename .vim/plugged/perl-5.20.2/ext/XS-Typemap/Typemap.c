...
XS_EXTERNAL(boot_XS__Typemap)
{
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("XS::Typemap::T_BOOL_2", XS_XS__Typemap_T_BOOL_2, file);
        newXS("XS::Typemap::T_BOOL_OUT", XS_XS__Typemap_T_BOOL_OUT, file);
        ...
        newXS("XS::Typemap::T_PV_null", XS_XS__Typemap_T_PV_null, file);
